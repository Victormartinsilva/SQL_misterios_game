...
from src.biblioteca.puzzles import puzzles_biblioteca, Puzzle

console = Console()

DB_PATH = "sql-mystery/data/biblioteca.db"
SEED_PATH = "sql-mystery/seeds/seed_biblioteca.sql"
...
def play_biblioteca_game():
    display_title("SQL Mystery: O Detetive de Banco de Dados - Episódio 1: Biblioteca")
    display_message("Bem-vindo ao mistério da biblioteca! Um livro raro desapareceu e precisamos da sua ajuda para encontrá-lo.")
    display_message("Você será o detetive e usará suas habilidades em SQL para resolver o caso.")
    
    setup_database()

    for i, puzzle in enumerate(puzzles_biblioteca):
    ...
    display_message("Você resolveu todos os mistérios da Biblioteca!", style="bold green")
